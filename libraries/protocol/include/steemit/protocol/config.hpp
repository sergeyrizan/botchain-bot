/*
 * Copyright (c) 2016 Bots, Inc., and contributors.
 */
#pragma once
...
#define BLOCKCHAIN_NAME "BOTCHAIN"

#define STEEMIT_SYMBOL                          "BOTCON"
#define STEEMIT_ADDRESS_PREFIX                  "BOT"
...
#define STEEMIT_INIT_PUBLIC_KEY_STR             "BTSd4siEKX87DK44xmhAD92hqJeR8Acsw6BKCtVnGLC5VDs56Wys3E"
#define BLOCKCHAIN_NAME                         "BOTCHAIN"
#define STEEMIT_CHAIN_ID                        (fc::sha256::hash(BLOCKCHAIN_NAME))
...
#define STEEM_SYMBOL  (uint64_t(3) | (uint64_t('B') << 8) | (uint64_t('O') << 16) | (uint64_t('T') << 24) | (uint64_t('C') << 32) | (uint64_t('N') << 40)) ///< BOTCN with 3 digits of precision
